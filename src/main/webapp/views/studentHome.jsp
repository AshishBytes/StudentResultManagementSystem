<%@page import="com.ashish.ConnectionProvider"%>
...
try
{
  ...
  ResultSet rs = st.executeQuery("SELECT * FROM student INNER JOIN result ON student.roll_number = result.roll_number WHERE student.roll_number = '" + rollNo + "'"); // Correct SQL query
	if(rs.next()){
%>

<div>
	<div style="width:10%;float:left"><img src="../assets/images/logo.png"  align="left"width="100" height="100"></div>
	<div style="width:80%;float:left"><center><h2 style="margin-top:25px";><b>Amity University Gwalior</h2></center></div>
	<div style="width:10%;float:left"><img src="../assets/images/atul1.png" align="right" margin-top="1px" width="100" height="100"></div>
</div>
    <a href="../pages/dgiOneView.html">Back</a>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Institution Name: AMITY University Gwalior</th>
      ...
      <thead>
        <tr>
          ...
          <th><a titlt="print screen" alt="print screen" onclick="window.print();" target="_blank" style="cursor:pointer;"><center><img src="../assets/images/print.png"></center></a></th>
        </tr>
      </thead>
    </table>
  </div>
...
Designed & Developed by Ashish Singh</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @AshishBytes</h6></center> 
  <hr class="new1">
</body>
...
{
   response.sendRedirect("../pages/errorDgiOneView.html");
}
}
catch(Exception e){
	}%>

...
<div class="w3-container">`
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo')">Registered Students</button>
     ...
     <a href="../pages/adminLogin.html" class="w3-bar-item w3-button tablink">Logout</a>
  </div>
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact AMITY University Gwalior.
Designed & Developed by Ashish Singh</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @AshishBytes</h5></center> 
  <hr class="new1">
<br>
</body>
</html>